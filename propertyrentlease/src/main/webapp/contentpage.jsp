...
<body>
        ...
        <div class="dropdown-buttons">
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    <a href="/buyerview">Buy Flat</a>
                    <a href="#">Buy House</a>
                    <a href="http://localhost:8080/PropertyRentLease/AdminDashboard">Buy PG Hostel</a>
                </div>
            </div>
            <div class="dropdown">
                <button class="dropbtn">
            ...
            <div class="profile-dropdown">
                ...
                <div class="profile-content">
                    <form action="/logout" method="post">
                        <button type="submit" style="background:none;border:none;padding:10px;width:100%;text-align:left;">Logout</button>
                    </form>
                </div>
            </div>
        <% } %>
    ...
    <div class="content">
        ...
        <div class="carousel">
            <div><img src="images/homw.jpg" alt="Property 1"></div>
            <div><img src="images/house with familly.jpg" alt="Property 2"></div>
            <div><img src="images/apartment.jpg" alt="Property 3"></div>
        </div>
    </div>
    <footer>
